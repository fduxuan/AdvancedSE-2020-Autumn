...
PCMEMBERS_LIMIT = DatabaseError(next(err_count), "至少需要3个pcmember")
DRAFT_SCORED = DatabaseError(next(err_count), "存在文稿未打分")
REBUTTAL_DRAFT_SCORED = DatabaseError(next(err_count), "存在rebuttal文稿未打分")
